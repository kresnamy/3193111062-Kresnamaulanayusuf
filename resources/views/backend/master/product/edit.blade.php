        ...
        <div class="col-12">
            @component('components.backend.card.card-form')
                ...
                @slot('content')
                    ...
                    <x-forms.input type="number" name="stock" id="stock" :label="__('Stock')" 
                    :isRequired="true" value="{{ $data['product']->stock }}"/>

                    <x-forms.input type="text" name="ukuran" id="ukuran" :label="__('Ukuran')" 
                    :isRequired="true" value="{{ $data['product']->ukuran }}"/>
