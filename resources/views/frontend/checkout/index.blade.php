    ...
    <section class="checkout spad">
        <div class="container">
            <form action="{{ route('checkout.process') }}" class="checkout__form" method="POST">
                @csrf
                <div class="row">
                    <div class="col-lg-8 mb-4" style="background-color: #f5f5f5; padding: 50px; border-radius: 20px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="checkout__form__input">
                                    <p>No Hp <span>*</span></p>
                                    <input type="number" name="phone_number"  required min="10">
                                </div>
                            </div>
                        ...
                        <div class="checkout__order">
                            ...
                            <div class="checkout__order__product">
                                <ul>
                                    ...
                                    @endforeach
                                    <li>
                                        <span class="top__text">Total Berat Belanja</span>
                            ...
                            <div class="checkout__order__total">
                                <ul>
                                    <li>Subtotal <span style="color: #5B2C6F;">{{ rupiah($data['carts']->sum('total_price_per_product')) }}</span>
                                    </li>
                                    <li>Biaya Pengiriman <span id="text-cost" style="color: #5B2C6F;">Rp 0</span></li>
                                    <li>Total <span style="color: #5B2C6F;" id="total">{{ rupiah($data['carts']->sum('total_price_per_product')) }}</span></li>
