        ...
        <div class="container">
                                ...
                                @foreach ($data['carts'] as $carts)
                                    <tr>
                                        ...
                                        <td class="cart__quantity">
                                            <div class="pro-qty">
                                                <input style="background-color: #E8DAEF" type="text" value="{{ $carts->qty }}" name="cart_qty[]">
                                            </div>
                                        </td>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="cart__btn">
                        <a href="{{ route('product.index') }}">Lanjut Belanja?</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-2">
                    <div class="cart__total__procced">
                        <h6>Total Belanja</h6>
                        <ul>
                            <li>Total <span style="color: #5B2C6F">{{ rupiah($data['carts']->sum('total_price_per_product')) }}</span></li>
                        </ul>
                        <a href="{{ route('checkout.index') }}" class="primary-btn">Proses Pemesanan</a>
                    </div>
                </div>
            </div>
        </div>
