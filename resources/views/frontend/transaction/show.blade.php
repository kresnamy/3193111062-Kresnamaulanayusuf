...
@section('content')
    ...
    <section class="shop-cart spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="invoice" style="border-top: 10px solid #4A235A;">
                        ...
                        <div class="text-md-right">
                            ...
                            <button onclick="window.print()" class="btn btn-warning btn-icon icon-left"><i class="fa fa-print"></i> Print</button>
                        </div>
                    </div>
                </div>
            </div>
...
@push('js')
    ...
    <form action="{{ route('transaction.store') }}" method="post" id="form-order">
        @csrf
